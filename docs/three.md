...
Will I run one of these myself? Maybe. If I had a month of happy forward testing, I think I'd go for it. I haven't incorporated slippage calculations, and some of these assets aren't very liquid. Some see under a million USD in volume over a 24 hour period, so how much that'd effect the strategy is an unknown for now. Furthermore, while I discussed my hyperparameter cheating earlier, it's worth reiterating. What I've done is textbook overfitting. I would use the best hyperparameters found for forward testing, but I would expect different pairs to be the best. The reason I haven't just used more data is just that it doesn't exist. All data is off of HyperLiquid, a newer exchange that isn't yet banned, but its data doesn't go far back enough. After excluding coins that had been added after just 18 months ago, I was left with just 71 assets, a very small universe for pair consideration. 
